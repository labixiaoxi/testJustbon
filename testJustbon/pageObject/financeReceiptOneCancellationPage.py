...
class FinanceOneCancellation(BasePage):

    project_cancel_click = 'xpath=>//div[@class="row"]/div/form/table/tbody/tr[3]/td[2]/div/span/span[1]/span/span[1]/span'
    project_input = 'xpath=>//div[@id="openRobot"]/following-sibling::span/span/span[1]/input'
    project_click = 'xpath=>//li[contains(text(),"（成都）香境·香碧歌")]'
