...
class TestLoginCase(unittest.TestCase):
    ...
    #     self.neighbor.jbNeighbor_click_forum_post()
    #
    # def test_s_neighbor_002(self):
    #     """邻里---业主论坛---对帖子点赞和评论"""
    #     self.neighbor.jbNeighbor_click_fabulous()
    #     # self.neighbor.jbNeighbor_input_content("评论")
    #     # self.neighbor.jbNeighbor_click_comment()
    #     self.operate.get_back()
    #
    # def test_s_neighbor_003(self):
    #     """邻里---业主论坛---发帖"""
    #     self.neighbor.jbNeighbor_click_posting()
    #     self.neighbor.jbNeighbor_click_posting_content()
    ...
    #     self.neighbor.jbNeighbor_click_release()
    #
    ...
    def test_z_loginOut_010(self):
        """个人设置---账号注销"""
        self.setting.click_cancellation_loc()
        self.operate.get_back()
